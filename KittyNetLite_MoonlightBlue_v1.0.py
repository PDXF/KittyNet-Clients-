...
class KittyNetLite(QWidget):
    ...
    def init_ui(self):
        ...
        self.setStyleSheet("""
            QWidget {
                background: #2C3E50;  /* Dark Moonlight Blue */
                color: white;
                font-family: Arial, sans-serif;
            }
            QLabel {
                font-size: 16px;
                color: #BDC3C7;  /* Light Blue Gray */
            }
            QPushButton {
                background-color: #2980B9;  /* Moonlight Blue */
                border-radius: 12px;
                padding: 10px;
                color: white;
                font-size: 14px;
            ...
            QTextEdit {
                background-color: #34495E;  /* Deep Blue Gray */
                border: 1px solid #5D6D7E;
                border-radius: 12px;
                padding: 10px;
                font-size: 14px;
                color: #EAECEE;  /* Off White Blue */
            }
            QLineEdit {
                background-color: #2C3E50;  /* Same Dark Moonlight Blue */
                border-radius: 10px;
                padding: 10px;
                font-size: 14px;
                color: #EAECEE;  /* Off White Blue */
        ...
        self.chat_display.setStyleSheet("""
            background-color: #1A252F;  /* Darker Moonlit Blue */
            border-radius: 10px;
            padding: 10px;
            font-size: 14px;
    ...
    def display_message(self, message, is_sender):
        color = "#2980B9" if is_sender else "#FF7F50"  
